...
const ContactUsRight = () => {
  return (
    <div>
         <span className='flex mb-10'><h1 className='font-normal text-5xl mr-2'>Our </h1>
        ...
        <div>
            ...
            <div className="flex items-center justify-center w-16 h-16  mr-[30px]  rounded-tr-xl rounded-bl-xl rounded-tl-md rounded-br-md bg-[#FF7906]">
            ...
            <div className='flex items-center bg-[#F5F5F5] mb-[30px] p-[30px] shadow-sm border'>
            <div className="flex items-center justify-center w-16 h-16  mr-[30px]  rounded-tr-xl rounded-bl-xl rounded-tl-md rounded-br-md bg-[#FF7906]">
            <HiOutlineMailOpen className='text-white text-3xl'/>
				</div>
                <div>
