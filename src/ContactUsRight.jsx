...
const ContactUsRight = () => {
  return (
    <div>
         <span className='flex my-10'><h1 className='font-normal text-5xl mr-2'>Our </h1>
        <h1 className='font-bold text-5xl text-[#FF7906]'>Address</h1>
        </span>
        ...
        <div>
            ...
            <div className="flex items-center justify-center w-16 h-16 mb-4 m-4 mr-[30px]  rounded-tr-xl rounded-bl-xl rounded-tl-md rounded-br-md bg-[#FF7906]">
            <FaMapLocationDot className='text-white text-3xl'/>
				</div>
                <div>
            ...
            <div className='flex items-center bg-[#F5F5F5] mb-[30px] p-[30px] shadow-sm border'>
            <div className="flex items-center justify-center w-16 h-16 mb-4 m-4 mr-[30px]  rounded-tr-xl rounded-bl-xl rounded-tl-md rounded-br-md bg-[#FF7906]">
            <HiOutlineMailOpen className='text-white scale-150'/>
				</div>
                <div>
