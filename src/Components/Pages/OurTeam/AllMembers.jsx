        ...
        {cards.map((card) => (
          <div key={card.id} className="relative group">
            ...
            <div className="relative w-full overflow-hidden rounded shadow-lg">
              ...
              {/* SVG Icons */}
              <div className="absolute inset-0 flex items-center justify-center text-center translate-y-16 md:translate-y-16 lg:translate-y-12 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ">
                <ul className="flex space-x-3">
                  <li>
                    <a
                      href="#"
                      title=""
                      className="flex items-center justify-center text-white bg-[#FF7906] rounded-md w-7 h-7"
                    >
                      <svg
                        className="w-4 h-4"
